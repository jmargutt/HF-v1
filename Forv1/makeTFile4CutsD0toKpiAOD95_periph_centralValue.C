...
void makeInputAliAnalysisTaskSED0Mass(Float_t minc=10., Float_t maxc=40.){
...
//  RDHFD0toKpi->SetMaxDifferenceTRKV0Centraltity(5.);
  ...
  TFile* fout=new TFile(Form("D0toKpi2011RefCuts%s%s%sRecVtx%sPileupRej_cent.root", RDHFD0toKpi->GetUseCentrality()==0 ? "pp" : "PbPb",cent.Data(),RDHFD0toKpi->GetIsPrimaryWithoutDaughters() ? "" : "No",RDHFD0toKpi->GetOptPileUp() ? "" : "No"),"recreate");   //set this!! 
