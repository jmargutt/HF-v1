...
void RunAnalysisAODVertexingHF()
{
  ...
  gSystem->SetIncludePath("-I. -I$ROOTSYS/include -I$ALICE_ROOT -I$ALICE_ROOT/EMCAL -I$ALICE_ROOT/PWGGA -I$ALICE_ROOT/PWGCF -I$ALICE_ROOT/PWGHF -I$ALICE_ROOT/PWGHF/hfe -I$ALICE_ROOT/include -I$ALICE_PHYSICS -I$ALICE_PHYSICS/include -I$ALICE_ROOT/ITS -I$ALICE_ROOT/TPC -I$ALICE_ROOT/CONTAINERS -I$ALICE_ROOT/STEER -I$ALICE_ROOT/STEER/STEER -I$ALICE_ROOT/STEER/STEERBase -I$ALICE_ROOT/STEER/ESD -I$ALICE_ROOT/STEER/AOD -I$ALICE_ROOT/TRD -I$ALICE_ROOT/macros -I$ALICE_ROOT/OADB -I$ALICE_ROOT/PWGHF/base -I$ALICE_ROOT/ANALYSIS  -I$ALICE_PHYSICS/OADB -I$ALICE_PHYSICS/PWGHF -I$ALICE_PHYSICS/PWGHF/base -I$ALICE_PHYSICS/PWGHF/vertexingHF -I$ALICE_PHYSICS/PWG/FLOW/Base -I$ALICE_PHYSICS/PWG/FLOW/Tasks -I$ALICE_PHYSICS/PWG -I$ALICE_ROOT/PWG/FLOW/Base -I$ALICE_PHYSICS/PWGPP/ZDC -g");
  //
  ...
  if(useAlienPlugin) {
    ...
    AliAnalysisGrid *alienHandler = CreateAlienHandler(pluginmode,useParFiles,mergeViaJDL);
...
//  taskMu->SetSelectedTriggerClass(AliVEvent::kINT7);
...
//  AddTaskFlowQnVectorCorrectionsToLegoTrainNewDetConfig("alien:///alice/cern.ch/user/p/pwg_hf/common/QnConfig/LHC15o/pass1");
  ...
  //D0
  AliAnalysisTaskHFv1 *DZero = AddTaskHFv1(1,kTRUE,"alien:///alice/cern.ch/user/j/jmargutt/HF/D0toKpi2011RefCutsPbPb1040NoRecVtxNoPileupRej_cent.root",AliAnalysisTaskHFv1::kD0toKpi,"D0toKpiCuts",kFALSE,"_3050_step2_QoverM_cent",AliAnalysisTaskHFv1::kZDC,10.,40.,kFALSE,AliAnalysisTaskHFv1::kSP,"QoverM",AliAnalysisTaskHFv1::kq2TPC,1);
  
//  gROOT->LoadMacro("$ALICE_PHYSICS/PWGHF/vertexingHF/charmFlow/AddTaskHFvn.C");
//  AliAnalysisTaskSEHFvn *DZero = AddTaskHFvn(2,"alien:///alice/cern.ch/user/a/afestant/v2_cutObjects/D0toKpi2011RefCutsPbPb3050NoRecVtxNoPileupRej_cent.root",AliAnalysisTaskSEHFvn::kD0toKpi, "D0toKpiCuts",kFALSE, "_3050_step2_QoverM_cent",AliAnalysisTaskSEHFvn::kVZERO,30.,50.,kTRUE,AliAnalysisTaskSEHFvn::kEP,"QoverM");
...
//
AliAnalysisGrid* CreateAlienHandler(TString pluginmode="test",Bool_t useParFiles=kFALSE,Bool_t mergeViaJDL=kTRUE)
{
...
//  Int_t runArray[] = {246984};
  ...
  plugin->SetGridWorkingDir("D0_FirstRunZDC/test1");
  // Name of executable
  ...
  plugin->AddIncludePath("-I. -I$ROOTSYS/include -I$ALICE_ROOT -I$ALICE_ROOT/EMCAL -I$ALICE_ROOT/PWGGA -I$ALICE_ROOT/PWGCF -I$ALICE_ROOT/PWGHF -I$ALICE_ROOT/PWGHF/hfe -I$ALICE_ROOT/include -I$ALICE_PHYSICS -I$ALICE_PHYSICS/include -I$ALICE_ROOT/ITS -I$ALICE_ROOT/TPC -I$ALICE_ROOT/CONTAINERS -I$ALICE_ROOT/STEER -I$ALICE_ROOT/STEER/STEER -I$ALICE_ROOT/STEER/STEERBase -I$ALICE_ROOT/STEER/ESD -I$ALICE_ROOT/STEER/AOD -I$ALICE_ROOT/TRD -I$ALICE_ROOT/macros -I$ALICE_ROOT/OADB -I$ALICE_ROOT/PWGHF/base -I$ALICE_ROOT/ANALYSIS  -I$ALICE_PHYSICS/OADB -I$ALICE_PHYSICS/PWGHF -I$ALICE_PHYSICS/PWGHF/base -I$ALICE_PHYSICS/PWGHF/vertexingHF -I$ALICE_PHYSICS/PWG/FLOW/Base -I$ALICE_PHYSICS/PWG/FLOW/Tasks -I$ALICE_PHYSICS/PWG -I$ALICE_ROOT/PWG/FLOW/Base -I$ALICE_PHYSICS/PWGPP/ZDC -g");
